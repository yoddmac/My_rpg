...
void open_scene_fight(game_t *game)
{
    ...
    damage_zombie(game, game->fight->life_zombie1);
    damage_perso(game);
...
void fight_change_scene(game_t *game)
{
    ...
    game->perso->perso_max_health = 150;
